        ...
        <div className="form-control mb-10">
            <div className="relative">
                <form onSubmit={handleSubmit}>
                    <input type="text" onChange={(e) => setVideoUrl({ url: e.target.value })} placeholder="Enter Youtube Video URL" className="ml-8 w-50 pr-16 input input-danger input-bordered rounded-r-none md:rounded-r md:w-full md:ml-0" />
